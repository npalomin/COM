...
###### 18. Next we can create the 'International' map with similar aesthetics. We also use the function coord_equal to improve the look of the map
```{r}
...
###### 3. Now it is possible to create the geom_curve object for the 'sbb_od' dataframe. We set the size of lines according to 'Backers'
```{r}
...
###### 4. One last step before using the theme_map function, is to label the curves that end outside of the plot.
```{r}
